...
class Post {
	...
	public function submitPost($body, $user_to, $imageName) {
		...
		if($check_empty != "") {
			...
			//insert post 
			$query = mysqli_query($this->con, "INSERT INTO post2 VALUES('', '$body', '$added_by', '$user_to', '$date_added', 'no', 'no', '0', '$imageName')");
	...
	public function loadPostsFriends($data, $limit) {
		...
		$data_query = mysqli_query($this->con, "SELECT * FROM post2 WHERE deleted='no' ORDER BY id DESC");
	...
	public function loadProfilePosts($data, $limit) {
		...
		$str = ""; //String to return 
		$data_query = mysqli_query($this->con, "SELECT * FROM post2 WHERE deleted='no' AND ((added_by='$profileUser' AND user_to='none') OR user_to='$profileUser')  ORDER BY id DESC");
	...
	public function getSinglePost($post_id) {
		...
		$str = ""; //String to return 
		$data_query = mysqli_query($this->con, "SELECT * FROM post2 WHERE deleted='no' AND id='$post_id'");
